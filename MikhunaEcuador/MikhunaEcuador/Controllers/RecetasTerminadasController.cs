...
namespace MikhunaEcuador.Controllers
{
    public class RecetasTerminadasController : Controller
    {
        ...
        {
            return View(db.RecetasTerminadas.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "RecetaTerminadaID")] RecetasTerminadas recetasTerminadas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RecetaTerminadaID")] RecetasTerminadas recetasTerminadas)
        {
            if (ModelState.IsValid)
            {
